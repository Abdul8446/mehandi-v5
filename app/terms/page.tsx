              ...
              <div className="max-w-3xl mx-auto prose prose-brown">
                <section className="mb-12">
                  ...
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                    ...
                    <li>We also sell henna cones and henna related products online.</li>
                  </ul>
                </section>
                ...
                <section className="mb-12">
                  ...
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                    ...
                    <li>You must provide a valid Indian mobile number with whatsapp to create an account.</li>
                  </ul>
                </section>
                ...
                <section className="mb-12">
                  ...
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                    ...
                    <li>Shipping notifications with tracking details will be sent via WhatsApp or SMS to your registered mobile number.</li>
