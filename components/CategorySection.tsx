...
//               className="group block relative overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-all: ease-in transition-shadow duration-300"
//             >
...
//                     </p>
//                     <span 
//                       className="inline-block text-sm font-medium border-b-2 border-amber-500 pb-1 opacity-0 transform translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300"
//                      >
//                       Explore Collection
//                     </span>
//                   </div>
