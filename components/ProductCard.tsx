  ...
  return (
    <div className='relative'>
      ...
      {/* <motion.button
        ...
        whileHover={!isMobile && addToCartLoadingProductId !== product._id ? "hover" : {}}
        whileTap={addToCartLoadingProductId !== product._id ? "tap" : {}}
      >
        {addToCartLoadingProductId === product._id ? (
          <div className="flex items-center">
      ...
      >
        <AnimatePresence mode="wait">
          {addToCartLoadingProductId === product._id ? (
            ...
            >
              <ShoppingCart size={16} className="mr-1" />
              <span>{product.stock === product.reserved ? 'Sold Out' : 'Add'}</span>
            </motion.div>
          )}
        </AnimatePresence>
      </motion.button>
